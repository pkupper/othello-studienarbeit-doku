...
Die Cowthello KI, nutzt im Wesentlichen die Cowthello Heuristik, die auch in der in dieser Arbeit entwickelten KI verwendet wird, passt
diese jedoch an, wenn Ecken des Spielfelds belegt werden. \cite{cowthello}

Im Spiel gegen die in dieser Arbeit entwickelten ProbCut Strategie, mit einer festen Suchtiefe von 5 Halbzügen, gewinnt die ProbCut Strategie, wie in Tabelle \ref{table:comp:cowthello} in 100\,\%  der Spiele.
