...
$\frac{-e}{\sigma}$ ist standardnormalverteilt mit Verteilungsfunktion $\Phi$, da der Mittelwert $\mu_1=0$ und die Standardarbeichung $\sigma_1=\frac{\sigma}{\sigma}=1$ ist.
...
Analog kann gezeigt werden, dass folgende Formel gilt:
