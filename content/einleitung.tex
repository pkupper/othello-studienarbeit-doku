...
Das \autoref{chap:merkmale} behandelt die Bestimmung optimaler Parameter für die K\acp{KI}. Dazu gehören die in der
...
In \autoref{chap:ergebnis} wird die Stärke der KI, sowie die Auswirkungen von ProbCut untersucht.

Im \autoref{chap:diskussion} werdem die Ergebnisse der Arbeit reflektiert bewertet. Außerdem werden Schlüsse bezüglich
