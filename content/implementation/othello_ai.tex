...
zunächst sematisch unsinnig, hat sich aber in Tests als effektiver
gegenüber möglichen Alternativen, wie der Verwendung einer
durchschnittlichen Mobilität für diesen Spieler in der jeweiligen
Spielphase, bewiesen.
...
wichtiger für die Bewertung ist, als die aktuelle Mobilität
\cite[S. 9]{evaluationfunctions}. Dieser Sachverhalt soll durch eine
lineare Kombination modelliert werden.
...
Künstlichen Intelligenz ist die Messung der Stärke, der anderen KI's.
...
zurückgegeben werden können. Die Eingabe- und der Rückgabeparameter
gleichen der Funktion \passthrough{\lstinline!alphabeta!}.
...
beste Zug ausgewählt, sondern statdessen einer der Züge, die innerhalb
...
durch die Konstante \passthrough{\lstinline!SECS\_PER\_MOVE!} gegebene
